#!/bin/bash
camset_dir=./camsets/camset_0205_ABCD_retry
...
python -m camera_utils.calibrate_tool --cam "${camset_dir}/A" --base ./camsets/camset_tvl20/A --inguess
python -m camera_utils.calibrate_tool --cam "${camset_dir}/B" --base ./camsets/camset_tvl20/A --inguess
python -m camera_utils.calibrate_tool --cam "${camset_dir}/D" --base ./camsets/camset_tvl20/A --inguess
# python -m camera_utils.calibrate_tool --cam "${camset_dir}/A" --base ./camsets/camset_0205_ABCD/A/camera.pickle --inguess
# python -m camera_utils.calibrate_tool --cam "${camset_dir}/D" --base ./camsets/camset_0205_ABCD/A/camera.pickle --infix
