...
python -m camera_utils.calibrate_tool --cam "${camset_dir}/A" --base ./camsets/base/A --infix
python -m camera_utils.calibrate_tool --cam "${camset_dir}/D" --base ./camsets/base/A --infix
